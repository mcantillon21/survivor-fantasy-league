    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-8">
      <div className="text-center max-w-2xl">
        ...
        <div className="space-y-4 max-w-md mx-auto">
          <Link
            href="/challenge"
            className="block bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 px-8 transition uppercase tracking-wide"
          >
            Enter Challenge Arena
          </Link>
          <Link
            href="/standings"
            className="block bg-transparent hover:bg-white/5 border border-orange-500/50 text-orange-400 font-bold py-4 px-8 transition uppercase tracking-wide"
          >
            View Standings
          </Link>
        </div>
